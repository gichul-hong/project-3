...
## Stable Diffusion 3.5 Personalization via Rectified Flow Inversion & Multi-Objective Ensemble
...
| **Exp-14** | **Extreme Prompt Alignment** | **LoRA HQ + Soft ODE** | **CFG 7.5 + Soft ODE + Pure CLIP-T Maximizer** | **0.3402 🥇** | 0.7162 | 1.0565 | **역대 최고 CLIP-T 극대화 달성** |

---

## 📈 3. 서브젝트별 심층 정량 지표 비교 (Exp-05 vs Exp-11 vs Exp-13 vs Exp-14)

| 서브젝트 (Concept) | Exp-05 (LoRA 베이스) | Exp-11 (Identity 특화) | Exp-13 (🏆 종합 SOTA) | **Exp-14 (🥇 프롬프트 극대화)** | 주요 정성 특징 |
| :--- | :---: | :---: | :---: | :---: | :--- |
| `actionfigure_2` | 0.3109 / 0.5808 | 0.3002 / 0.7069 | 0.3105 / 0.6407 | **0.3278 / 0.6319** | 프롬프트 속 행동/배경 100% 렌더링 |
| `decoritems_woodenpot` | 0.3637 / 0.6616 | 0.3353 / 0.7530 | 0.3498 / 0.7842 | **0.3693 / 0.7209** | 꽃/나비/눈밭 프롬프트 완벽 반영 |
| `furniture_sofa2` | 0.3044 / 0.7787 | 0.2762 / 0.8505 | 0.3208 / 0.8423 | **0.3356 / 0.8140** | **Total 1.1496 - 프롬프트/텍스처 양립** |
| `instrument_music2` | 0.3522 / 0.6925 | 0.2911 / 0.7917 | 0.3490 / 0.7637 | **0.3633 / 0.7337** | 기타 연주/무대 조명 극대화 |
| `luggage_backpack1` | 0.3288 / 0.7320 | 0.3097 / 0.8372 | 0.3251 / 0.8241 | **0.3416 / 0.8065** | **Total 1.1481 - 하이킹/도심 배경 완성** |
| `person_3` | 0.3055 / 0.5151 | 0.3052 / 0.6048 | 0.3059 / 0.5739 | **0.3177 / 0.5403** | 포즈 및 의상 변화 프롬프트 충실도 상승 |
| `pet_cat5` | 0.3227 / 0.7361 | 0.3202 / 0.7771 | 0.3315 / 0.7896 | **0.3389 / 0.7823** | **Total 1.1213 - 고양이 표정/행동 일치** |
| `scene_waterfall` | 0.3332 / 0.7472 | 0.3348 / 0.7759 | 0.3450 / 0.7609 | **0.3491 / 0.7526** | **Total 1.1017 - 겨울 빙하/가을 단풍 변환** |
| `transport_tank` | 0.3016 / 0.5723 | 0.2713 / 0.6824 | 0.3002 / 0.6223 | **0.3374 / 0.6152** | 사막/설원/도시 전투 배경 렌더링 |
| `wearable_jacket1` | 0.3164 / 0.7142 | 0.2965 / 0.7820 | 0.3117 / 0.7939 | **0.3214 / 0.7650** | **Total 1.0865 - 착용 모델/패션쇼 배경 완성** |
| **전체 평균 (TOTAL)** | **0.3239 / 0.6731** | **0.3041 / 0.7561** | **0.3249 / 0.7396** | **0.3402 / 0.7162** | **CLIP-T 0.3402 🥇 역대 최고치 경신!** |
